...
\begin{exm}
    ...
    \begin{center}
        ...
        \end{tikzpicture}
    \end{center}
    A matching is $\{(1,3), (4,5), (2,6), (7,8), (9,10)\}$. An independent set is $\{1, 4, 8, 10, 11, 12\}$. A clique is $\{2,4,6,8\}$. Indeed these are all optimal and
    \begin{align*}
        \alpha'(\hat{G})    &= 5 \\
        \alpha(\hat{G})     &= 6 \\
        \omega(\hat{G})     &= 4.
    \end{align*}
    The independence number can be determined since you can partition $V$ into 6 cliques such that each clique is maximal.
\end{exm}
